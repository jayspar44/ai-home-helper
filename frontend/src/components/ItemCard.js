    ...
    >
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <div className="font-medium text-base mb-1" style={{ color: 'var(--text-primary)' }}>
            {item.name}
          </div>
          ...
          <div className="text-sm font-medium flex items-center gap-1" style={{ color: expiryInfo.color }}>
